...
public class exampleTrip implements Parcelable {
    ...
    protected exampleTrip(Parcel in) {
        ffrom = in.readString();
        tto = in.readString();
        date = in.readString();
        time = in.readString();
    ...
    public static final Creator<exampleTrip> CREATOR = new Creator<exampleTrip>() {
        @Override
        public exampleTrip createFromParcel(Parcel in) {
            return new exampleTrip(in);
        }

        @Override
        public exampleTrip[] newArray(int size) {
            return new exampleTrip[size];
        }
    };
